...
def generar_ventas(numeroVentas):
    ...
    vendedores = ["Leo Messsi", "Ronaldo Nazario", "Ronaldinho Gaucho", "Neymar Jr", "Andres Iniesta"]
    ...
    for i in range(numeroVentas):
        ...
        venta = {
            ...
            "cantidad": cantidad,
            "vendedor": random.choice(vendedores) if vendedores else "VendedorMock",
            "fecha": fecha,
            "total": cantidad * producto["precio"]
        }

        # Inyectando errores de calidad de datos
        ...
        ventas.append(venta)  # ← estaba fuera del for
