...
#Me gustaria ver las ventas de Leo Messi o de Cristiano Ronaldo
ventas_vendedores_Messi_Ronaldo=datosOrdenados.query("vendedor == 'Leo Messi' or vendedor == 'Cristiano Ronaldo'")
...
vendedor_buscado="Leo Messi"
ventas_leo_messi=datosOrdenados.query("vendedor == @vendedor_buscado")
